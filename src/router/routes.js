const routes = [
  {
    ...
    children: [
      ...
      { path: 'patterns/new', component: () => import('pages/PatternForm.vue'), meta: { title: 'TECHMANIA | New Pattern', login: true, recaptcha: true } },
      { path: 'patterns/edit/:id', component: () => import('pages/PatternForm.vue'), meta: { title: 'TECHMANIA | Edit Pattern', login: true, recaptcha: true } },
      { path: 'patterns/:id', component: () => import('pages/Pattern.vue'), meta: { title: 'TECHMANIA', login: false, recaptcha: true } },
      { path: 'patterns', component: () => import('pages/Patterns.vue'), meta: { title: 'TECHMANIA | Patterns', login: false } },
      { path: 'skins/new', component: () => import('pages/SkinForm.vue'), meta: { title: 'TECHMANIA | New Skin', login: true, recaptcha: true } },
